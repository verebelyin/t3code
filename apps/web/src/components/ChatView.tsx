...
import { deriveLatestRateLimitsSnapshot } from "../lib/rateLimits";
...
function ChatViewContent(props: ChatViewProps) {
  ...
  const activeRateLimitsSnapshot = useMemo(
    () => deriveLatestRateLimitsSnapshot(threadActivities),
    [threadActivities],
  );
  ...
  const richToolCallRows = useClientSettings((settings) => settings.richToolCallRows);
  const expandedToolCalls = useClientSettings((settings) => settings.expandedToolCalls);
              ...
              >
                <div className="pointer-events-auto relative z-10">
                  ...
                  >
                    <div
                      className={cn(
                        "chat-composer-glass-shell relative mx-auto w-full max-w-[var(--chat-max-width,48rem)]",
                      ...
                      <div className="chat-composer-glass-host relative z-10 w-full rounded-[22px]">
                        <div ref={attachDraftHeroComposerAnchorRef} className="relative z-10">
                          <ChatComposer
                            ...
                            activeRateLimitsSnapshot={activeRateLimitsSnapshot}
