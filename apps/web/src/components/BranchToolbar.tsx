...
export const BranchToolbar = memo(function BranchToolbar({
  ...
  return (
    <div
      ...
      className="chat-composer-context-strip group/composer-context -mt-4 mx-auto flex w-[calc(100%-2.75rem)] max-w-[calc(var(--chat-max-width,48rem)-2.75rem)] items-center gap-2 overflow-x-clip overflow-y-visible ps-1 pe-2 pt-5 pb-1"
    >
